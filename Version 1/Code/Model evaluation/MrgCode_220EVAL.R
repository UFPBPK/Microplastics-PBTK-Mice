...
PK     : 0.251     : Unitless, Partition coefficient of Kidney   ; Lin et al., 2016
...
PASC   : 0.00249   : Unitless, Membrane-limited permeability coefficient of Spleen       ; Fitted
PABRC  : 0.000001  : Unitless, Membrane-limited permeability coefficient of Brain        ; Lin et al., 2016
PARC   : 0.00224   : Unitless, Membrane-limited permeability coefficient of Rest of body ; Fitted
...
KLuRESmax         : 0.643     : 1/h,      Maximum uptake rate constant of phagocytic cells; Fitted
...
KKRESmax           : 0.291    : 1/h,      Maximum uptake rate constant of phagocytic cells; Fitted
...
KLRESmax           : 0.00427  : 1/h,      Maximum uptake rate constant of phagocytic cells; Fitted
ALREScap           : 100      : ug/g,     tissue, Uptake capacity per tissue weight; Chou et al., 2023_Table S2

// #+ Uptake and elimination parameters
KGIb               : 4.22e-5   : 1/h, Absorption rate of GI tract; Fitted
Kfeces             : 0.55      : 1/h, Fecal clearance; Fitted
KbileC             : 0.0012    : L/h/kg^0.75, Biliary clearance; Lin et al., 2016
KurineC            : 0.0003    : L/h/kg^0.75, Urinary clearance; Fitted

// #+ Albumin-binding parameters
KD                 : 2464.7    : mg/L, Equilibrium dissociation constant      ; Fitted
...
pred.eval <- function(pars) {
  ...
  return(list("out.L"= out.L,
                "out.C1" = out.C1, "out.C2" = out.C2, "out.C3" =out.C3,
                "out.H"= out.H,
                "out.T"= out.T,
                "out.Z"= out.Z
              )
...
Ctheta <- log(c(BW = 0.03))
Sim.fitC1 = pred.eval(Ctheta)$out.C1       
Sim.fitC2 = pred.eval(Ctheta)$out.C2     
Sim.fitC3 = pred.eval(Ctheta)$out.C3     
...
#------------------------------
df.simC = cbind.data.frame (Time=Sim.fitC1$Time, CKidneyL=Sim.fitC1$CKidney, 
                            CLiverL=Sim.fitC1$CLiver, CGIL=Sim.fitC1$CGI, 
                            CKidneyM=Sim.fitC2$CKidney, CLiverM=Sim.fitC2$CLiver,
...
addWorksheet(wb, "Choi")
writeData(wb, "Choi", selected_Crows)
...
saveWorkbook(wb, "Eval.500.xlsx", overwrite = TRUE)

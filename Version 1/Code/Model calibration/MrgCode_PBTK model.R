PBTK.code <-'
$PROB
## Microplastics (MPs) and nanoplastics (NPs) PBTK model for male mouse
- Author    : Chi-Yun Chen
...
KGIb               : 6e-5      : 1/h, Absorption rate of GI tract; Chou et al., 2022_Table S3
Kfeces             : 0.53      : 1/h, Fecal clearance; Chou et al., 2022_Table S3
